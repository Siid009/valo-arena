...
const socialLinks = [
  ...
  { href: "https://x.com/Siddhant96shaw", icon: <FaTwitter /> },
  { href: "https://www.youtube.com/@valorant", icon: <FaYoutube /> },
  { href: "https://www.linkedin.com/in/siddhantshaw/", icon: <FaLinkedin /> },
  { href: "https://github.com/Siid009", icon: <FaGithub /> },
];
    ...
    <footer className="w-screen bg-red-secondary py-4 text-black">
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row">
        <p className="text-center text-base font-medium md:text-left">
          ©{new Date().getFullYear()} Siddhant Shaw. All rights reserved
        </p>
